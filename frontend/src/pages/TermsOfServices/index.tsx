export default function TermsOfSercices() {
  return (
    <div className="p-10">
      ...
      <h1 className="pt-7 pb-1 text-3xl font-semibold">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Task Tracker.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Task Tracker, accessible from{" "}
            <a
              href="https://task-tracker-tool.netlify.app"
      ...
      <h1 className="pt-7 pb-1 text-3xl font-semibold">Acknowledgment</h1>
      <p>
      ...
      <p>
        ...
        information such as your name, username, and password to provide you
        with a safe, customized, and efficient experience. We use a JSON Web
        Token (JWT)-token for user authentication in our website. The JWT-token
        is a digitally signed JSON object that contains information about the
        user's identity and is used to authenticate the user when they log in to
        our website. The JWT-token is stored in the local storage of the user's
        browser, which allows us to keep the user logged in even after they
        close their browser or leave our website. We take all necessary
        precautions to keep the user data safe and secure, including the
        JWT-token stored in the local storage. Please note that while we take
        all necessary precautions to keep user data safe and secure, there is
        always a risk of unauthorized access or data breaches, and we cannot
      ...
      <h1 className="pt-7 pb-1 text-3xl font-semibold">Termination</h1>
      <p>
      ...
      <h1 className="pt-7 pb-1 text-3xl font-semibold">Governing Law</h1>
      <p>
      ...
      <h1 className="pt-7 pb-1 text-3xl font-semibold">Disputes Resolution</h1>
      <p>
      ...
      <h1 className="pt-7 pb-1 text-3xl font-semibold">Copyright Notice</h1>
      <p>Copyright © 2023 Haopeng Zeng. All rights reserved.</p>
      <h1 className="pt-7 pb-1 text-3xl font-semibold">Contact Us</h1>
      <p>
